...
class AuthRequestPayload(BaseModel):
    ...
    is_remember_me: Optional[StrictBool] = Field(default=False, description="Extend token expiration", alias="isRememberMe")
    __properties: ClassVar[List[str]] = ["email", "password", "isRememberMe"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthRequestPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "isRememberMe": obj.get("isRememberMe") if obj.get("isRememberMe") is not None else False
        })
        return _obj
