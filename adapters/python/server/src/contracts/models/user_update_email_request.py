...
class UserUpdateEmailRequest(BaseModel):
    ...
    """ # noqa: E501
    new_email: StrictStr = Field(description="Email address", alias="newEmail")
    password: Annotated[str, Field(min_length=8, strict=True)] = Field(description="Password (minimum 8 characters)")
    __properties: ClassVar[List[str]] = ["newEmail", "password"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserUpdateEmailRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserUpdateEmailRequest from a dict"""
        if obj is None:
            return None
